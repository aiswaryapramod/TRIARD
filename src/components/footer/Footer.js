...
function Footer() {
    ...
    const footerInfo1 = useRef();


    useEffect(() => {
        gsap.fromTo(footerInfo1.current, { translatex: '100%' }, {
            scrollTrigger: {
                trigger: '.footer-left',
        ...
        <>
            ...
            <footer className="footer-distributed">
                ...
                <div className="footer-left" >
                    ...
                    <p className="footer-company-name">Copyright © 2023 Digitalbuddha Info Solutions LLP</p>
                </div>

                <div className="footer-center" ref={footerInfo1}>
                    ...
                    <div>
                        ...
                        <p><a href="mailto:info@triard.io">info@triard.io</a></p>
                    </div>
                ...
                <div className="footer-right">
                    ...
                    <p className="footer-company-about">
                        ...
                        We are a trusted IT partner agency offering tailored solutions to help businesses succeed. Experienced team, focus on latest technologies.
                    </p>

                    <div className="footer-icons">

                        <div className="social-link">
                            <a href='https://www.instagram.com/triard.io/'>
                            ...
                            <a href='https://www.facebook.com/triard.3d'>
                            ...
                            <a href='https://twitter.com/triard_io'>
                            ...
                            <a href='https://www.linkedin.com/company/triard/'>
                        ...
                        <p className="footer-company-name_bottom">Copyright © 2023 Digitalbuddha Info Solutions LLP</p>
      ...
      <ul className="nav__ul nav__ul--extra">
        ...
        <li>
          <a href="#">Software Design</a>
                    ...
                    <li className="nav__item">
                        <h2 className="nav__title">INDUSTRIES</h2>
                    ...
                    <li className="nav__item">
                        <h2 className="nav__title">ABOUT THE COMPANY</h2>
                        <p>                        We are a trusted IT partner agency offering tailored solutions to help businesses succeed. Experienced team, focus on latest technologies.
                        </p>
