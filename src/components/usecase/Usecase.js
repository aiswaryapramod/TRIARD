    ...
    <div>
      ...
      <div>
        ...
        <div className='usecase_content'>
          <div className='case1' ref={containerUsecase}>
          ...
          <div className='case2' ref={containerUsecase1}>
          ...
          <div className='case1' ref={containerUsecase2}>
            <div className='case1_info'>
          ...
          <div className='case2' ref={containerUsecase3}>
            <div className='case2_img'>
              <img src={jewelry}></img>
            </div>
          ...
          <div className='case1' ref={containerUsecase4}>
            <div className='case1_info'>
          ...
          <div className='case2' ref={containerUsecase5}>
            <div className='case2_img'>
              <img src={Sports}></img>
            </div>
          ...
          <div className='case1' ref={containerUsecase6}>
            <div className='case1_info' >
          ...
          <div className='case2' ref={containerUsecase7}>
            <div className='case2_img'>
